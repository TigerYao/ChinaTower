...
exports.default = exports.defaultFailed = void 0;
...
var FormItemType = {
  input: _.NomarInput,
  select: _.NomarPicker,
  area: _.NomarTextArea,
  date: _.NomarDatePicker,
  switch: _.NomarSwitch,
  radio: _.NomarRadio,
  extraInput: _.ExtraInput,
  rangeDatePicker: _.RangeDatePicker,
  coverRadio: _.CoverRadio,
  multiplePicker: _.MultiplePicker,
  image: _.NomarImagePicker,
  checkbox: _.NomarCheckBox
};
var radioList = [{
  label: '是',
  value: 'yes'
...
var EditFormItemType = {
  title: _.NomarInput,
  fieldProps: _.NomarInput,
  required: _.NomarSwitch,
  placeholder: _.NomarInput,
  disabled: _.NomarRadio,
  data: _.NomarInput,
  type: _.NomarInput,
  positionType: function positionType(props) {
    return /*#__PURE__*/_react.default.createElement(_.NomarPicker, _extends({
  ...
  fieldProps2: _.NomarInput,
  placeholder2: _.NomarInput,
...
var getFormItem = function getFormItem(fieldItemKey) {
  ...
  return /*#__PURE__*/_react.default.createElement(EditFormItemComponent, {
...
var getShowDeitItem = function getShowDeitItem(editData) {
  ...
  return /*#__PURE__*/_react.default.createElement(ShowItemComponent, otherProps);
};
...
var EditForm = function EditForm(_ref3) {
  ...
  var _useState = (0, _react.useState)(_objectSpread({}, data)),
  ...
  }, /*#__PURE__*/_react.default.createElement(_rcFieldForm.default, null, /*#__PURE__*/_react.default.createElement(_list.default, {
    renderHeader: function renderHeader() {
      return '效果演示';
    }
  }, getShowDeitItem(editData))), /*#__PURE__*/_react.default.createElement(_rcFieldForm.default, {
    form: form,
  ...
  })), /*#__PURE__*/_react.default.createElement(_whiteSpace.default, {
    size: "lg"
  }), /*#__PURE__*/_react.default.createElement(_rcFieldForm.Field, null, /*#__PURE__*/_react.default.createElement(_button.default, {
    type: "primary",
