...
var _multiplePickerGroup = _interopRequireDefault(require("./multiplePickerGroup"));
...
var MultiplePicker = function MultiplePicker(props) {
  ...
  }, title), subTitle)), /*#__PURE__*/_react.default.createElement(_Field.default, {
    name: fieldProps,
    rules: rules || [{
      required: required,
  ...
  }, /*#__PURE__*/_react.default.createElement(_multiplePickerGroup.default, _extends({}, props, {
    initValue: initValue
  }), required && hasStar && /*#__PURE__*/_react.default.createElement("span", {
    className: "alitajs-dform-redStar"
  }, "*"), /*#__PURE__*/_react.default.createElement("span", {
