import 'antd-mobile/es/pull-to-refresh/style';
import _PullToRefresh from 'antd-mobile/es/pull-to-refresh';
import 'antd-mobile/es/list-view/style';
...
var LoadMoreListView = function LoadMoreListView(_ref) {
  ...
  var _useState = useState(document.documentElement.clientHeight),
  ...
  var _useState5 = useState(new _ListView.DataSource({
  ...
  var _useLoadMore = useLoadMore(asyncFn, [container], {
    ref: containerRef,
  ...
  return React.createElement("div", null, data.length === 0 && !loading && noData && React.createElement("div", {
    onClick: function onClick() {
      reload();
    }
  }, noData), React.createElement("div", {
    style: {
      display: data.length || loading || !noData ? 'block' : 'none'
    },
    ref: containerRef
  }, isInit && React.createElement(_ListView, _extends({
