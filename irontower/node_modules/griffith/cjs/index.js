...
var BigScreen = _interopDefault(require('isomorphic-bigscreen'));
var griffithMessage = require('griffith-message');
...
var elementResizeEvent = _interopDefault(require('element-resize-event'));
...
class Time extends React__default.Component {
  render() {
    ...
    return React__default.createElement("span", null, formatTime(value));
  }
...
function Icon({
  ...
  const children = React.cloneElement(icon, {
    className: noImportant.css(styles.svg)
  });
  return React__default.createElement("span", {
    className: noImportant.css(styles.root, customStyles)
  }, children);
}
...
var alert = React__default.createElement("svg", {
  viewBox: "0 0 20 20"
...
var pause = React__default.createElement("svg", {
  viewBox: "0 0 72 72"
...
var play = React__default.createElement("svg", {
  viewBox: "0 0 72 72"
}, React__default.createElement("g", {
  fill: "none",
  fillRule: "evenodd"
...
var replay = React__default.createElement("svg", {
  viewBox: "0 0 24 24"
}, React__default.createElement("g", {
  fill: "none",
  fillRule: "evenodd"
...
var styles$1 = noImportant.StyleSheet.create({
  root: {
    width: '4em',
    height: '4em'
  },
...
class Loader extends React.Component {
  render() {
    return React__default.createElement("div", {
      className: noImportant.css(styles$1.root)
    }, React__default.createElement("svg", {
      viewBox: "0 0 64 64",
      className: noImportant.css(styles$1.svg)
    }, React__default.createElement("circle", {
      className: noImportant.css(styles$1.circle)
    })));
  }

}

const VideoSourceContext = React__default.createContext({});
...
class VideoSourceProvider extends React__default.Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "setCurrentQuality", quality => {
      ...
      if (prevQuality !== quality) {
        ...
        this.props.onEvent(griffithMessage.EVENTS.PLAYER.QUALITY_CHANGE, {
          prevQuality,
          quality
        });
      }
  ...
  render() {
    ...
    return React__default.createElement(VideoSourceContext.Provider, {
      value: {
        dataKey,
        qualities,
        format,
...
const InternalContext = React__default.createContext({});
InternalContext.displayName = 'InternalMessageContext';
/**
 * 用于播放器外部，只能接收播放器发出的 Event, 或者向播放器发送 Action
 */

const ExternalContext = React__default.createContext({});
ExternalContext.displayName = 'ExternalMessageContext';
class MessageProvider extends React__default.PureComponent {
  constructor(props) {
    super(props);
    ...
    const {
      subscribeMessage,
      dispatchMessage
    } = griffithMessage.createMessageHelper(id, targetOrigin);
  ...
  render() {
    ...
    }, React__default.createElement(ExternalContext.Provider, {
      value: {
...
const ObjectFitContext = React__default.createContext({});
ObjectFitContext.displayName = 'ObjectFitContext';

const VALID_FIT = ['fill', 'contain', 'cover', 'none', 'scale-down'];
class ObjectFitProvider extends React__default.Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    return React__default.createElement(ObjectFitContext.Provider, {
      value: {
        objectFit,
...
const PositionContext = React__default.createContext({
  isFullWidth: false
});
PositionContext.displayName = 'PositionContext';

var styles$2 = noImportant.StyleSheet.create({
  root: {
    position: 'relative',
    width: '100%',
    height: '100%'
...
class PositionProvider extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "ref", React__default.createRef());
    ...
    _defineProperty(this, "updateHelperImageSrc", () => {
      ...
      const [width, height] = griffithUtils.reduce(videoWidth, videoHeight);
  ...
  render() {
    ...
    return React__default.createElement(PositionContext.Provider, {
      ...
      className: noImportant.css(styles$2.root),
      ref: this.ref
    }, children));
  }
...
const eventMap = [[griffithMessage.EVENTS.DOM.PLAY, 'onPlay'], [griffithMessage.EVENTS.DOM.PLAYING, 'onPlaying'], [griffithMessage.EVENTS.DOM.PAUSE, 'onPause'], [griffithMessage.EVENTS.DOM.ENDED, 'onEnded'], [griffithMessage.EVENTS.DOM.TIMEUPDATE, 'onTimeUpdate'], [griffithMessage.EVENTS.DOM.ERROR, 'onError'], [griffithMessage.EVENTS.DOM.WAITING, 'onWaiting']];
...
const VideoWithMessage = React__default.forwardRef((props, ref) => {
  const renderChildren = (emitEvent, objectFit, updateVideoSize) => {
    ...
    eventMap.map(([eventName, key]) => {
      ...
      newProps[key] = griffithUtils.sequence(emit, handler || noop);
    });
    ...
    const newOnLoadedMetadata = griffithUtils.sequence(updateVideoSizeOnLoadedMetadata, props.onLoadedMetadata || noop);
    const {
      Video,
      ...otherProps
    } = props;
    return React__default.createElement(Video, _extends({}, otherProps, newProps, {
      ref: ref,
      style: {
        objectFit
      },
  ...
  return React__default.createElement(PositionContext.Consumer, null, ({
    updateVideoSize
  }) => React__default.createElement(ObjectFitContext.Consumer, null, ({
    objectFit
  }) => React__default.createElement(InternalContext.Consumer, null, ({
    emitEvent
...
const NormalVideo = ({
  ...
  sources,
  ...props
}) => React__default.createElement("video", _extends({}, props, {
  ref: onRef
}));
...
function selectVideo(format, useMSE) {
  if (format === 'm3u8') {
    ...
    } else if (griffithUtils.isMSESupported() && !griffithUtils.isHlsNativeSupported()) {
  ...
  if (format === 'mp4') {
    if (typeof __WITHOUT_MP4__ === 'undefined' ? false : __WITHOUT_MP4__) {
      return NormalVideo$1;
    } else if (griffithUtils.isMSESupported() && useMSE) {
...
var styles$3 = noImportant.StyleSheet.create({
  root: {
    display: 'block',
    width: '100%',
    height: '100%'
...
class Video extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleError", () => {
      ...
      griffithUtils.logger.debug('Error: %o', {
        code,
        message,
        name
      });
      ...
      if (!dontReportPlayFailed) {
        this.props.onEvent(griffithMessage.EVENTS.PLAYER.PLAY_FAILED, {
          currentTime
        });
      }
  ...
  render() {
    ...
    return React__default.createElement(VideoWithMessage, {
      onRef: node => {
        this.root = node;
      },
      className: noImportant.css(styles$3.root),
      preload: "metadata",
      playsInline: true,
      "webkit-playsinline": "",
...
var Video$1 = React__default.forwardRef((props, ref) => React__default.createElement(VideoSourceContext.Consumer, null, ({
  currentSrc,
  sources,
  currentQuality,
  format
...
var styles$4 = noImportant.StyleSheet.create({
  root: {
    display: 'flex',
    alignItems: 'center',
    height: '2.5em',
...
var fullscreen = React__default.createElement("svg", {
  viewBox: "0 0 24 24"
}, React__default.createElement("path", {
...
var muted = React__default.createElement("svg", {
  viewBox: "0 0 24 24"
}, React__default.createElement("path", {
...
var pause$1 = React__default.createElement("svg", {
  viewBox: "0 0 24 24"
}, React__default.createElement("path", {
...
var play$1 = React__default.createElement("svg", {
  viewBox: "0 0 24 24"
}, React__default.createElement("path", {
...
var smallscreen = React__default.createElement("svg", {
  viewBox: "0 0 24 24"
}, React__default.createElement("path", {
...
var volume = React__default.createElement("svg", {
  viewBox: "0 0 24 24"
}, React__default.createElement("path", {
...
const PlayButtonItem = ({
  ...
  className: noImportant.css(styles$4.toggle)
}, React__default.createElement("button", {
  className: noImportant.css(styles$4.button),
  onClick: onClick
...
var styles$5 = noImportant.StyleSheet.create({
  root: {
    overflow: 'hidden',
    userSelect: 'none',
    cursor: 'pointer',
...
const horizontal = noImportant.StyleSheet.create({
  root: {
    height: '1em',
    padding: `0 0.5em`
  },
...
const vertical = noImportant.StyleSheet.create({
  root: {
    width: '1em',
    padding: `0.5em 0`
  },
...
class Slider extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "trackRef", React__default.createRef());
  ...
  getClassName(...names) {
    return noImportant.css(...Array.prototype.concat.apply([], names.map(name => this.getStyles(name))));
  }
  ...
  render() {
    ...
    }, interactionProps), React__default.createElement("div", {
      className: this.getClassName('inner')
    }, React__default.createElement("div", {
      ref: this.trackRef,
      className: this.getClassName('track')
    }, Boolean(buffered) && React__default.createElement("div", {
    ...
    })), !noInteraction && React__default.createElement("div", {
...
var styles$6 = noImportant.StyleSheet.create({});
const slider = noImportant.StyleSheet.create({
  root: {
    height: 40
  },
  track: {
...
const hoveredSlider = noImportant.StyleSheet.create({
  thumb: {
    transform: 'scale(1)'
  }
});
const minimal = noImportant.StyleSheet.create({
  root: {
    position: 'absolute',
    bottom: 0,
    left: 0,
...
class Timeline extends React.Component {
  ...
  render() {
    ...
    return React__default.createElement("div", {
      className: noImportant.css(styles$6.root),
      onMouseEnter: this.handlePointerEnter,
      onMouseLeave: this.handlePointerLeave
    }, React__default.createElement(Slider, _extends({}, this.props, {
...
class MinimalTimeline extends React.Component {
...
const TimelineItem = props => React__default.createElement("div", {
  className: noImportant.css(styles$4.timeline)
}, React__default.createElement(Timeline, props));
...
const CombinedTimeItem = ({
  ...
  className: noImportant.css(styles$4.time, isFullScreen && styles$4.fullScreenedTime)
}, React__default.createElement("div", {
  className: noImportant.css(styles$4.timeText)
...
const LocaleContext = React__default.createContext('en');
...
const TranslatedText = ({
  name
}) => React__default.createElement(LocaleContext.Consumer, null, locale => strings[locale][name]);
...
class QualityMenuItem extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    return React__default.createElement(VideoSourceContext.Consumer, null, ({
      qualities,
      setCurrentQuality,
      currentQuality
    }) => qualities.length > 1 && React__default.createElement("div", {
      className: noImportant.css(styles$4.menuContainer),
      onMouseEnter: this.handleQualityPointerEnter,
      onMouseLeave: this.handleQualityPointerLeave
    }, React__default.createElement("button", {
      className: noImportant.css(styles$4.button, styles$4.qualityButton)
    }, React__default.createElement("span", {
      className: noImportant.css(styles$4.qualityButtonText)
    }, React__default.createElement(TranslatedText, {
      name: QUALITIES[currentQuality]
    }))), React__default.createElement("div", {
      className: noImportant.css(styles$4.menu, isQualityHovered && styles$4.menuShown)
    }, React__default.createElement("div", {
      className: noImportant.css(styles$4.qualityMenu)
    }, reverseArray(qualities).map(q => React__default.createElement("button", {
      key: q,
      className: noImportant.css(styles$4.qualityMenuItem, currentQuality === q && styles$4.qualityMenuActiveItem),
...
var styles$7 = noImportant.StyleSheet.create({
  root: {
    padding: '0.375em 0'
  }
});
const slider$1 = noImportant.StyleSheet.create({
  root: {
    width: '2.5em',
    height: '4em'
  },
...
class VolumeSlider extends React.Component {
  render() {
    return React__default.createElement("div", {
      className: noImportant.css(styles$7.root)
    }, React__default.createElement(Slider, _extends({}, this.props, {
      styles: slider$1,
...
const VolumeItem = ({
  ...
  className: noImportant.css(styles$4.menu, menuShown && styles$4.menuShown)
}, React__default.createElement(VolumeSlider, {
  value: volume$1,
  total: 1,
...
var styles$8 = noImportant.StyleSheet.create({
  root: {
...
class Tooltip extends React.Component {
  render() {
    ...
    return React__default.createElement("div", {
      className: noImportant.css(styles$8.root)
    }, React__default.createElement(TranslatedText, {
      name: content
    }));
  }
...
class Hover extends React__default.Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    return React__default.createElement("div", _extends({}, rest, {
      onMouseEnter: griffithUtils.sequence(this.handlePointerEnter, onMouseEnter || noop),
      onMouseLeave: griffithUtils.sequence(this.handlePointerLeave, onMouseLeave || noop)
    }), children(isHovered));
  }
...
const FullScreenButtonItem = ({
  isFullScreen,
  onClick
}) => React__default.createElement(Hover, {
  className: noImportant.css(styles$4.menuContainer)
}, isFullScreenHovered => React__default.createElement(React__default.Fragment, null, React__default.createElement("button", {
  className: noImportant.css(styles$4.button),
  onClick: onClick
}, React__default.createElement(Icon, {
  icon: isFullScreen ? smallscreen : fullscreen
})), React__default.createElement("div", {
  className: noImportant.css(styles$4.fullScreenTooltip, styles$4.menu, isFullScreenHovered && styles$4.menuShown, isFullScreen && styles$4.fullScreenTooltipWide)
}, !isMobile$2 && React__default.createElement(Tooltip, {
...
class Controller extends React.Component {
  ...
  render() {
    ...
    return React__default.createElement("div", {
      className: noImportant.css(styles$4.root, isFullScreen && styles$4.fullScreened)
    }, React__default.createElement(PlayButtonItem, {
      isPlaying: isPlaying,
    ...
    }), React__default.createElement(CombinedTimeItem, {
      isFullScreen: isFullScreen,
      currentTime: displayedCurrentTime,
      duration: duration
    }), !hiddenQualityMenu && React__default.createElement(QualityMenuItem, null), !hiddenVolumeItem && React__default.createElement(VolumeItem, {
      volume: volume,
    ...
    }), React__default.createElement(FullScreenButtonItem, {
      isFullScreen: isFullScreen,
...
var styles$9 = noImportant.StyleSheet.create({
  root: {
    position: 'relative',
    overflow: 'hidden',
    userSelect: 'none',
...
const hiddenOrShownStyle = noImportant.StyleSheet.create({
  base: {
...
class Player extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "playerRef", React__default.createRef());

    _defineProperty(this, "videoRef", React__default.createRef());
    ...
    _defineProperty(this, "handlePlay", (type = null) => {
      ...
      onEvent(griffithMessage.EVENTS.PLAYER.REQUEST_PLAY);
      onBeforePlay().then(() => {
        if (!this.state.isPlaybackStarted) {
          onEvent(griffithMessage.EVENTS.PLAYER.PLAY_COUNT);
          this.setState({
        ...
        onEvent(griffithMessage.EVENTS.PLAYER.PLAY_REJECTED); // 播放被取消
      });
    });

    _defineProperty(this, "handlePause", (type = null) => {
      this.props.onEvent(griffithMessage.EVENTS.PLAYER.REQUEST_PAUSE);
      const {
        isLoading
      } = this.state;
    ...
    _defineProperty(this, "handleToggleFullScreen", () => {
      if (BigScreen.enabled) {
        ...
        const onEnter = () => onEvent(griffithMessage.EVENTS.PLAYER.ENTER_FULLSCREEN);

        const onExit = () => onEvent(griffithMessage.EVENTS.PLAYER.EXIT_FULLSCREEN);
  ...
  componentDidMount() {
    ...
    this.pauseActionSubscription = this.props.subscribeAction(griffithMessage.ACTIONS.PLAYER.PAUSE, this.handlePauseAction);
    const {
      autoplay
    } = this.props;
  ...
  render() {
    ...
    return React__default.createElement("div", {
      className: noImportant.css(styles$9.root, isFullScreen && styles$9.fullScreened),
      ...
      className: noImportant.css(styles$9.video)
    }, React__default.createElement(Video$1, {
      ref: this.videoRef,
      ...
      className: noImportant.css(styles$9.cover, !isPlaybackStarted && styles$9.coverShown),
      onClick: () => this.handlePlay()
    }, cover && React__default.createElement(ObjectFitContext.Consumer, null, ({
      objectFit
    }) => React__default.createElement("img", {
      className: noImportant.css(styles$9.coverImage),
      src: cover,
      style: {
        objectFit
      }
    })), duration && currentTime === 0 && React__default.createElement("div", {
      className: noImportant.css(styles$9.coverTime, isMobile$3 && styles$9.coverTimeMobile)
    }, React__default.createElement(Time, {
      value: duration
    })), isNeverPlayed && React__default.createElement("div", {
      className: noImportant.css(styles$9.coverAction)
    }, React__default.createElement("div", {
      className: noImportant.css(styles$9.actionButton)
    }, React__default.createElement(Icon, {
      icon: play,
      styles: styles$9.actionIcon
    }))), !isNeverPlayed && currentTime !== 0 && React__default.createElement("div", {
      className: noImportant.css(styles$9.coverReplayAction)
    }, React__default.createElement("div", {
      className: noImportant.css(styles$9.coverReplayButton, hovered && styles$9.coverReplayButtonHovered, pressed && styles$9.coverReplayButtonPressed)
    }, React__default.createElement(Icon, {
      icon: replay,
      styles: styles$9.replayIcon
    }), "\u91CD\u65B0\u64AD\u653E"))), !isMobile$3 && React__default.createElement("div", {
      className: noImportant.css(styles$9.overlay, isNeverPlayed && styles$9.overlayMask)
    }, isPlaybackStarted && isLoading && React__default.createElement("div", {
      className: noImportant.css(styles$9.loader)
    }, React__default.createElement(Loader, null)), lastAction && type !== 'button' && React__default.createElement("div", {
      className: noImportant.css(styles$9.action),
      key: lastAction
    }, React__default.createElement("div", {
      className: noImportant.css(styles$9.actionButton, styles$9.actionButtonAnimated)
    }, React__default.createElement(Icon, {
      icon: lastAction === 'play' ? play : pause,
      styles: styles$9.actionIcon
    }))), React__default.createElement("div", {
      className: noImportant.css(styles$9.backdrop),
      onTouchStart: event => {
        // prevent touch to toggle
        event.preventDefault();
      },
      onClick: this.handleToggle
    }), title && isFullScreen && React__default.createElement("div", {
      className: noImportant.css(styles$9.title, showController && styles$9.titleShown)
    }, title), isPlaying && (!isLoading || currentTime !== 0) && React__default.createElement("div", {
      className: noImportant.css(hiddenOrShownStyle.base, showController ? hiddenOrShownStyle.hidden : hiddenOrShownStyle.shown)
    }, React__default.createElement(MinimalTimeline, {
      buffered: bufferedTime,
      duration: duration,
      currentTime: currentTime,
      show: !showController
    })), isPlaybackStarted && (!isLoading || currentTime !== 0) && React__default.createElement("div", {
      className: noImportant.css(styles$9.controller, hiddenOrShownStyle.base, showController ? hiddenOrShownStyle.shown : hiddenOrShownStyle.hidden),
      ...
      className: noImportant.css(styles$9.error)
    }, React__default.createElement(Icon, {
      icon: alert,
      styles: styles$9.errorIcon
    }), error.message && React__default.createElement("div", {
      className: noImportant.css(styles$9.errorMessage)
    }, error.message)));
  }
...
const PlayerContainer = ({
  ...
  locale = 'en',
  autoplay
}) => React__default.createElement(ObjectFitProvider, {
  initialObjectFit: initialObjectFit
}, React__default.createElement(PositionProvider, {
  ...
  emitEvent,
  subscribeAction
}) => React__default.createElement(VideoSourceProvider, {
  onEvent: emitEvent,
  sources: sources,
  id: id
}, React__default.createElement(LocaleContext.Provider, {
  value: locale
}, React__default.createElement(VideoSourceContext.Consumer, null, ({
  currentSrc
}) => React__default.createElement(Player, {
  useMSE: useMSE,
  autoplay: autoplay,
  standalone: standalone,
  cover: cover,
...
var styles$a = noImportant.StyleSheet.create({
  container: {
    position: 'absolute',
    pointerEvents: 'none',
    overflow: 'hidden'
...
const getContainerClassName = isFullWidth => noImportant.css(styles$a.container, isFullWidth ? styles$a.containerFullWidth : styles$a.containerFullHeight);

const getImageClassName = isFullWidth => noImportant.css(styles$a.image, isFullWidth ? styles$a.imageFullWidth : styles$a.imageFullHeight);

const Positioned = ({
  children
}) => React__default.createElement(PositionContext.Consumer, null, ({
  isFullWidth,
  helperImageSrc
}) => helperImageSrc && React__default.createElement("div", {
...
function Layer({
  ...
  const layer = React__default.createElement("div", {
    className: noImportant.css(styles$a.layer)
  }, children); // 暂时先只考虑 cover

  return React__default.createElement(ObjectFitContext.Consumer, null, ({
    objectFit
  }) => objectFit === 'cover' ? layer : React__default.createElement(Positioned, null, layer));
}

exports.Controller = Controller;
exports.Layer = Layer;
exports.MessageContext = ExternalContext;
exports.VideoSourceContext = VideoSourceContext;
