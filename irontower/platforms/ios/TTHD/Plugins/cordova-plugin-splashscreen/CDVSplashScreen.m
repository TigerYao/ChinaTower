...
- (void)setInitHide:(BOOL)initHide {
    _initHide = initHide;
    [self hideViews];
}
...
- (void)createViews
{
    ...
    UIImage *image = [UIImage imageNamed:@"first-page"];
    UIImageView *topImageView = [[UIImageView alloc] init];
    topImageView.image = image;
    topImageView.contentMode = UIViewContentModeScaleAspectFit;
    [self.viewController.view addSubview:topImageView];
    [topImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.mas_equalTo(0);
        make.top.mas_equalTo(128+top);
    ...
    logoImageView.image = [UIImage imageNamed:@"icon-page"];
    [self.viewController.view addSubview:logoImageView];
    [logoImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(0);
        make.bottom.mas_equalTo(-1*(50 + bottom));
