...
- (void)__init
{
    NSLog(@"----- 加载开始 ------%lf", [[NSDate date] timeIntervalSince1970] * 1000);
...
{
    [super viewDidLoad];
    NSLog(@"----- viewDidLoad:1 ------%lf", [[NSDate date] timeIntervalSince1970] * 1000);
    ...
    NSLog(@"----- viewDidLoad:2 ------%lf", [[NSDate date] timeIntervalSince1970] * 1000);
    ...
    NSLog(@"----- viewDidLoad:2.1 ------%lf", [[NSDate date] timeIntervalSince1970] * 1000);
    /*
    ...
    NSLog(@"----- viewDidLoad:3 ------%lf", [[NSDate date] timeIntervalSince1970] * 1000);
    ...
    [self reloadWebView:appURL];

}

- (void)reloadWebView:(NSURL *)appURL {
    // /////////////////
//    NSURL* appURL = [self appUrl];
...
//    }];
    ...
    NSLog(@"----- viewDidLoad:4 ------%lf", [[NSDate date] timeIntervalSince1970] * 1000);
}
