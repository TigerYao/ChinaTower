...
//                .format(DecodeFormat.PREFER_ARGB_8888) // 设置图片解码格式, 默认 8888
    ...
    public static RequestOptions transformationOptions(final RequestOptions options, final Transformation transformation) {
        if (options != null) {
            try {
                ...
                LogUtils.e(TAG, e.getMessage() + "transformationOptions");
            }
        }
        return options;
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    LogUtils.e(TAG, e.getMessage() + "clearDiskCache");
                }
            }
        }).start();
    }
    ...
    public static void clearMemoryCache() {
        try {
            ...
            LogUtils.e(TAG, e.getMessage() + "clearMemoryCache");
        }
    }
    ...
    public static void onLowMemory() {
        try {
            ...
            LogUtils.e(TAG, e.getMessage() + "onLowMemory");
        }
    }
    ...
    public static File getDiskCache() {
        try {
            ...
            LogUtils.e(TAG, e.getMessage() + "getDiskCache");
        }
        return null;
    }
}
