...
public class SplashScreen extends CordovaPlugin {
    ...
    private static final int DEFAULT_SPLASHSCREEN_DURATION = 7000;
    ...
    protected void pluginInitialize() {
        Log.d("ckf", "SplashScreen pluginInitialize ");
        if (HAS_BUILT_IN_SPLASH_SCREEN) {
            return;
        }

        String url = cordova.getActivity().getIntent().getStringExtra("tran_data_key");
    ...
    public void onDestroy() {
        Log.d("ckf", "SplashScreen onDestroy");
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        Log.d(LOG_TAG, "SplashScreen " + action);
