...
public class GPSLocationUtils {
    ...
    private static final String TAG = GPSLocationUtils.class.getSimpleName().toString();
...
//        if (location == null) {
//            manager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 20, 1, listener);
//        }
        return location;
    }
