...
public class PopupMenuAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            convertView.setBackground(mContext.getDrawable(R.drawable.nim_popup_menu_item_first_back));
        } else if (position == list.size() - 1) {
            convertView.setBackground(mContext.getDrawable(R.drawable.nim_popup_menu_item_last_back));

        } else {
            convertView.setBackground(mContext.getDrawable(R.drawable.nim_popup_menu_item_selector));
