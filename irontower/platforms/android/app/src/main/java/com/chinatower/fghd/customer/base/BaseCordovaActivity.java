package com.chinatower.fghd.customer.base;
 ...
 * desc:
 */
public class BaseCordovaActivity extends CordovaActivity implements View.OnClickListener {
    ...
    public void setContentView(View view) {
        ...
        retrofitNetHelper = HRetrofitNetHelper.getInstance(this);
